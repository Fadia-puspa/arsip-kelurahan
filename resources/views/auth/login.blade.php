...
<html lang="en">
  ...
  <head>
    ...
    <title>ArsipKelurahan | Login </title>
    <!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="title" content="ArsipKelurahan | Login Page v2" />
      ...
      <div class="card card-outline card-primary mt-5 mb-5">
        <div class="card-header">
          <a
            ...
            >
            <img src="{{ 'img/arsipkelurahan.png' }}" alt="Logo Kelurahan" class=" mx-auto d-block" width="300" />
        </a>
        ...
        <div class="card-body login-card-body">
          ...
          <div class="text-center mt-3" style="cursor:pointer" onclick="landingpage()">
            <small>kembali ke awal</small>
